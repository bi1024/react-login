                    ...
                    <Card.Body>
                        ...
                        <Form.Group>
                            ...
                            <FloatingLabel
                                ...
                                className="mb-3"
                            >
                                <Form.Control required name="account" onChange={(event) => { setAccount(event.target.value); console.log(account) }} placeholder="Enter account" {...register("account", { required: true })} />
                            </FloatingLabel>
                        </Form.Group>
                        <Form.Group>
                            <FloatingLabel
                            ...
                            >
                                ...
                                <Form.Control required name="password" onChange={(event) => { setPassword(event.target.value); console.log(password) }} type="password" placeholder="Enter account" {...register("password", { required: true })} />
                            </FloatingLabel>
                        </Form.Group>
